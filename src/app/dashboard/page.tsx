...
const percentages = [
  { label: 'Done', value: 78, color: 'bg-slate-900 dark:bg-slate-100' },
  { label: 'Open', value: 17, color: 'bg-slate-400' },
  { label: 'Cancel', value: 5, color: 'bg-slate-200 dark:bg-slate-700' },
];
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              Good morning, {user.name}. Berikut ringkasan planner dan aktivitas maintenance untuk bulan ini.
            </p>
          </div>
